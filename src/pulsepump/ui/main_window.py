...
class MainWindow(QMainWindow):
    def __init__(self, loader: PicoLoader) -> None:
        ...
        self.sampling.sampleRateChanged.connect(self.plot.set_sample_rate)
        self.sampling.pinChanged.connect(self.loader.set_pin)
        self.sampling.pinChanged.connect(self.plot.set_channel_pin)
        self.sampling.timeWidthChanged.connect(self.plot.set_time_width)
        self.sampling.channelVisibilityChanged.connect(self.plot.set_channel_visible)
        self.plot.set_sample_rate(self.sampling.current_rate())
        self.plot.set_time_width(self.sampling.current_time_width())
        self.plot.set_channel_pin(1, self.sampling.current_pin(1))
        self.plot.set_channel_pin(2, self.sampling.current_pin(2))
        self.plot.set_channel_visible(1, self.sampling.current_channel_visibility(1))
        self.plot.set_channel_visible(2, self.sampling.current_channel_visibility(2))
